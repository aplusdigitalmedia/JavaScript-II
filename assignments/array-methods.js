...
fullName.push(arrayItem.first_name, arrayItem.last_name)
}
...
let allCaps = [];
allCaps = runners.map(function(arrayItems){
    return arrayItems.first_name.toUpperCase()
})
//console.log(allCaps); 
...
let largeShirts = [];
largeShirts = runners.filter(function(arrayItem){
...
ticketPriceTotal = runners.reduce(function(accumulator, currentItem){
  ...
  console.log(currentItem.donation);
